...
class VideoView(ModelView):
    ...
    column_list = ('user_id', 'course', 'event_time', 'type', 'timecode')
    ...
    column_formatters = dict(
        ...
        type=lambda v, c, m, p: app.config['video_types'][m.type]
    )
    ...
    column_choices = {
        'type': app.config['video_types'].items()
    }
